...
object PartitionerTest {
  def main(args: Array[String]): Unit = {
    ...
    val rdd: RDD[(Int, String)] =
      sc.parallelize(List[(Int, String)]((1, "a"), (2, "b"), (3, "c"), (4, "d"), (5, "e"), (6, "f")), 3)
    val count1 = rdd.mapPartitionsWithIndex((index, iter) => {
    ...
    val count = newRDD.mapPartitionsWithIndex((index, iter) => {
      val list = new ListBuffer[(Int, String)]()
      while (iter.hasNext) {
        val one = iter.next()
